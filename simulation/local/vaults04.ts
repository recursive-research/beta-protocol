...
// This is the scenario that governance tokens slightly increase in value compared to ETH
...
async function main() {
  ...
  // Swap $1m of ETH for ALCX
  let ethTradeAmount = ethers.utils.parseEther('225'); // ~$1m
  ...
  // Swap $45k ETH for INJ (almost the entire pool)
  ethTradeAmount = ethers.utils.parseEther('10'); // ~45k (only 700k in liquidity)
  ...
  ethTradeAmount = ethers.utils.parseEther('225'); // ~$1m
